    ...
    def _prepare_sub_modules(self, pretrained_model_name_or_path: str, diffusers_modules: list[str], transformers_modules: list[str]):
        ...
        try:
            try:
                ...
                get_trainer_service()._on_update_status(f"Downloading model {pretrained_model_name_or_path}...")
            except ImportError:
                pass
            ...
            try:
                from web_ui.backend.services.trainer_service import get_trainer_service
                get_trainer_service()._on_update_status(f"Model download complete")
            except ImportError:
                pass
