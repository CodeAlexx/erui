...
class BaseTrainer(
    ...
    def _start_tensorboard(self):
        # Use patched TensorBoard script to fix duplicate plugins error
        python_executable = sys.executable
        tensorboard_script = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "scripts", "tensorboard_patched.py")
